...
public class RecipeHandler {
	...
	public static void registerCraftingRecipes() {
		...
		registerToolRecipe(ModItems.tinIngot, ModTools.tinPickaxe, ModTools.tinAxe, ModTools.tinShovel, ModTools.tinHoe,
				ModTools.tinSword);
		registerArmourRecipe(ModItems.tinIngot, ModArmour.tinHelmet, ModArmour.tinChestplate, ModArmour.tinLeggings,
				ModArmour.tinBoots);
		...
		GameRegistry.addRecipe(new ItemStack(ModItems.tinIngot),
				new Object[] { "NNN", "NNN", "NNN", 'N', ModItems.tinNugget });
		GameRegistry.addShapelessRecipe(new ItemStack(ModItems.tinNugget, 9), new Object[] { ModItems.tinIngot });
		GameRegistry.addRecipe(new ShapedOreRecipe(ModItems.tinApple,
				new Object[] { "III", "IAI", "III", 'I', "ingotTin", 'A', Items.APPLE }));
		...
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(ModItems.niceBiscuit, 4),
				new Object[] { "cropWheat", "cropWheat" }));

		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModItems.chip, 1, 0),
				new Object[] { "TRT", "RGR", "TRT", 'T', "ingotTin", 'R', "dustRedstone", 'G', "dyeGreen" }));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModItems.chip, 1, 1),
				new Object[] { "TRT", "RCR", "TRT", 'T', "ingotTin", 'R', "dustRedstone", 'C', "chipBasic" }));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModBlocks.machineFrame, 1, 0), new Object[] { "TRT",
				"TCT", "RIR", 'R', "dustRedstone", 'T', "ingotTin", 'C', "chipBasic", 'I', Blocks.IRON_BLOCK }));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModBlocks.machineFrame, 1, 1), new Object[] { "TRT",
				"TCT", "RIR", 'R', "dustRedstone", 'T', "ingotTin", 'C', "chipAdvanced", 'I', Blocks.IRON_BLOCK }));

		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModBlocks.breaker, 1, 0),
				new Object[] { " P ", "RMR", "TTT", 'P', Items.IRON_PICKAXE, 'R', "dustRedstone", 'M',
						new ItemStack(ModBlocks.machineFrame, 1, 0), 'T', "ingotTin" }));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModBlocks.breaker, 1, 1),
				new Object[] { " P ", "RMR", "TTT", 'P', Items.IRON_PICKAXE, 'R', "dustRedstone", 'M',
						new ItemStack(ModBlocks.machineFrame, 1, 1), 'T', "ingotTin" }));

		GameRegistry.addRecipe(
				new ShapedOreRecipe(new ItemStack(ModBlocks.tinSlabHalf, 2), new Object[] { "TTT", 'T', "ingotTin" }));
		...
		GameRegistry.addRecipe(
				new ShapedOreRecipe(new ItemStack(ModBlocks.canvas, 2), new Object[] { "FF", "FF", 'F', "fabric" }));
		...
		GameRegistry.addRecipe(
				new ShapedOreRecipe(new ItemStack(ModItems.tinStick, 4), new Object[] { "T", "T", 'T', "ingotTin" }));
		...
		// Make sure to register the recipe type first!
	 ...
	 * 
	 * @param ingotOD
	 *            The ingot from the {@link OreDictionary}
	 * @param pickaxe
	 *            The pickaxe
	 * @param axe
	 *            The axe
	 ...
	 *            The sword
	 * @param stickOD
	 *            The stick from the {@link OreDictionary}
	 */
	private static void registerToolRecipe(String ingotOD, Item pickaxe, Item axe, Item shovel, Item hoe, Item sword,
			String stickOD) {
		GameRegistry.addRecipe(new ItemStack(pickaxe),
				new Object[] { "III", " S ", " S ", 'I', ingotOD, 'S', stickOD });
