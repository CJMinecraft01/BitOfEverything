...
/**
 * This block updates with a redstone signal and changes state based on the
 * nearest player's gamemode
 * 
 * @author CJMinecraft
 *
 */
public class BlockGamemodeDetector extends Block {
	...
	/**
	 * The property. Refer to {@link BlockBreaker} for the other properties
	 */
	...
	/**
	 * Makes it so that a comparator can get the gamemode and emit it as a
	 * redstone signal
	 */
	@Override
	...
	/**
	 * Update block when powered. I recommend using a {@link TileEntity} for
	 * this
	 */
	@Override
