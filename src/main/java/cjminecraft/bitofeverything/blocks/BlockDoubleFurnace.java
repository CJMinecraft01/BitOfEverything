...
public class BlockDoubleFurnace extends BlockContainer {
	...
	public BlockDoubleFurnace(String unlocalziedName) {
		super(Material.ROCK);
		this.setUnlocalizedName(unlocalziedName);
		this.setRegistryName(new ResourceLocation(Reference.MODID, unlocalziedName));
		this.setHardness(3);
	...
	public IBlockState getStateForPlacement(World world, BlockPos pos, EnumFacing facing, float hitX, float hitY,
		...
		return this.getDefaultState().withProperty(ACTIVATED, false).withProperty(FACING, placer.getHorizontalFacing().getOpposite());
	}
