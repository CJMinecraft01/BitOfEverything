...
/**
 * This class acts as a tool as in 1.10.2 ItemAxe was not fully functional. All
 * the code for this class was copied from the {@link ItemAxe} but with fixes
 * 
 * @author CJMinecraft
 *
 */
public class ItemModAxe extends ItemTool {
	...
	/**
	 * Create a new instance of an axe
	 * 
	 * @param material
	 *            The tool material of the axe
	 * @param unlocalizedName
	 *            The unlocalized name of the axe
	 */
